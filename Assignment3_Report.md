...
We can analyze the boundaries of column values and identify "on points" and "off points": 
...
- `isCellEditableWhenProjectIsRunning`
- `isCellEditableWhenProjectIsNotRunning`
- `isCellEditableShouldThrowException`
...
We can analyze the possible numbers of seconds and their partitions:
...
- `formatSecondsWithPositive`
- `formatSecondsWithNegative`
...
- `parseSecondsWithNegativeValues`
- `parseSecondsWithSecondsAndMinutesGreaterThan59`
- `parseSecondsValidValues`
